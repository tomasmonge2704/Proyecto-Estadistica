        ...
        <>
            <Card isHoverable variant="bordered" css={{ mw: "500px"}} className="cardConfianza">
                <Card.Body>
                    ...
                    <Spacer y={1} />
                    <Input id='proporcion' placeholder="Ej: 0.43" value={0.35}  type="number" label="Proporcion de elementos %" />
                    <Spacer y={1} />
                    <Input id='E' type="number" value={0.05} label="Error de muestreo no superior a :"/>
                    <Spacer y={1} />
