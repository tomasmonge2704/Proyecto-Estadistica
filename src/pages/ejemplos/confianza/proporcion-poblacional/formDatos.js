        ...
        <>
            <Card isHoverable variant="bordered" css={{ mw: "500px"}} className="cardConfianza">
                <Card.Body>
                    ...
                    <Spacer y={1} />
                    <Input id='R' value={560} type="number" label="Cantidad de elementos con atributo determinado"/>
                    <Spacer y={1} />
                    <Input id='N' value={800} type="number" label="Tamaño de la Poblacion"/>
                    <Spacer y={1} />
                    <Input id='confianza' value={90} placeholder="Ej: 95" type="number" label="Nivel de Confianza" />
                    <Spacer y={1} />
                </Card.Body>
            </Card>
        </>
