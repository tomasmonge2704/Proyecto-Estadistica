            ...
            <Card isHoverable variant="bordered" css={{ mw: "500px"}} className="cardConfianza">
                <Card.Body>
                    ...
                    <Grid.Container gap={2}>
                        <Grid xs={6}>
                        {datos.varianza ? (<Input id='desvio' type="number" value={Math.sqrt(datos.varianza)} label="Desvio(√varianza)"/>):(<Input id='desvio' value={20} type="number" label="Desvio(√varianza)"/>)}
                        </Grid>
                        <Grid xs={6}>
                    ...
                    :(<Grid.Container gap={2}>
                        <Grid xs={6}>
                            <Input id='N' type="number" value={250} label="Tamaño de muestra(N)"/>
                        </Grid>
                        <Grid xs={6}>
                    ...
                    (<Input id='media' type="number" value={obtenerMedia()} label="Media de la muestra"/>):(<Input id='media' type="number" value={90} label="Media de la muestra"/>)}
                    <Spacer y={1} />
