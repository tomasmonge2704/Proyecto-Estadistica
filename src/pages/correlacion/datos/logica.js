...
import { obtenerRho,obtenerBeta1, obtenerBeta0, obtenerErrorTipico, r2Ajustado,obtenerResiduales,SumaDeCuadrados,PromedioDeCuadrados,obtenerDesvioBeta0, obtenerDesvioBeta1,obtenerValorCriticoF, obtenerProbabilidad} from "@/components/formulas/correlacion"
export default function Logica({datos}) {
    if(datos.valores.length !== 0 ) {
        ...
        datos.valores = obtenerResiduales(datos);
